...
public class RemoveStaff extends javax.swing.JFrame {
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        String query = "DELETE FROM STAFFS WHERE STAFF_ID= '" + key + "' OR NAME = '" + key + "' ";
        try{
            Connection conn = DriverManager.getConnection(url , user , pwd);
            Statement stmt = conn.createStatement();
            int rows = stmt.executeUpdate(query);
            if(rows>0){
                JOptionPane.showMessageDialog(this , "Staff Member Deleted Succesfully");
            }else{
                JOptionPane.showMessageDialog(this , "No Such Staff Member Exist");
            }
            t1.setText(null);
            stmt.close();
        }catch(Exception e){
